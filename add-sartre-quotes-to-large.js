// Script to add Jean-Paul Sartre quotes to the largeQuotes.json file
const fs = require('fs');
...
// Read the Sartre quotes
const sartreQuotes = JSON.parse(fs.readFileSync('sartre-quotes.json', 'utf8'));
console.log(`Loaded ${sartreQuotes.length} Sartre quotes to add`);

// Add Sartre quotes to largeQuotes array
const updatedQuotes = [...largeQuotes, ...sartreQuotes];
...
console.log(`Successfully added ${sartreQuotes.length} Sartre quotes to largeQuotes.json`);
