// add-final-thousands-unique-quotes-to-database.js
const fs = require('fs');
...
const finalBatchQuotes = JSON.parse(fs.readFileSync('final-thousands-unique-philosophical-quotes.json', 'utf8'));
...
thematicContent = thematicContent.replace(/18,350\+/g, '23,350+');
...
footerContent = footerContent.replace(/18,350\+/g, '23,350+');
