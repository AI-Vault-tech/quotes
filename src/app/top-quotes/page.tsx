...
export default function TopQuotesPage() {
  ...
  const fetchQuotes = async () => {
    try {
      setLoading(true);
      // For now, we'll just fetch random quotes since we don't have a popularity metric
      // In a real implementation, this would sort by a popularity score
      ...
      <div className="min-h-screen bg-background py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h1 className="heading-text text-4xl md:text-5xl mb-6 text-accent">Top Quotes</h1>
            <p className="text-xl max-w-3xl mx-auto text-foreground/80">
              Discover the most beloved and widely-shared philosophical wisdom
            </p>
          </div>
