...
export default function QuotesOfTheDayPage() {
  ...
  const fetchQuotes = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/quotes?limit=100`); // Increased from 75 to 100
      ...
      <div className="min-h-screen bg-background py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h1 className="heading-text text-4xl md:text-5xl mb-6 text-accent">Quotes of the Day</h1>
            <p className="text-xl max-w-3xl mx-auto text-foreground/80">
              Discover inspiring philosophical wisdom curated for today
            </p>
          </div>
